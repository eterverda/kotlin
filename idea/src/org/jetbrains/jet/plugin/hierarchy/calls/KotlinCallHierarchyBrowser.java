...
public class KotlinCallHierarchyBrowser extends CallHierarchyBrowserBase {
    public KotlinCallHierarchyBrowser(@NotNull Project project, @NotNull JetNamedDeclaration declaration) {
        super(project, declaration);
    }
    ...
    protected boolean isApplicableElement(@NotNull PsiElement element) {
        return element instanceof JetNamedFunction
    ...
    protected HierarchyTreeStructure createHierarchyTreeStructure(@NotNull String typeName, @NotNull PsiElement psiElement) {
        if (typeName.equals(CALLER_TYPE)) {
            return new KotlinCallerMethodsTreeStructure(myProject, (JetNamedDeclaration) psiElement, getCurrentScopeType());
        }

        if (typeName.equals(CALLEE_TYPE)) {
            return new KotlinCalleeMethodsTreeStructure(myProject, (JetNamedDeclaration) psiElement, getCurrentScopeType());
        }
