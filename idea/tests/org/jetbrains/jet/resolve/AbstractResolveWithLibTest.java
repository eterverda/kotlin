...
import static org.jetbrains.jet.test.generator.SimpleTestClassModel.ALL_FILES_PRESENT_TEST_PREFIX;
...
public abstract class AbstractResolveWithLibTest extends AbstractResolveBaseTest {
    ...
    protected LightProjectDescriptor getProjectDescriptor() {
        ...
        if (startsWithIgnoreCase(testName, ALL_FILES_PRESENT_TEST_PREFIX.substring(4))) {
            return null;
        }
